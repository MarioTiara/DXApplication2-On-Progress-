(function() {
    ...
    function onRightMenuItemClickMaps(s, e) {
        if (e.item.name === "ToggleRightPanelMaps") {
            toggleRightPanel();
            e.processOnServer = false;
        }
    ...
    function onRightPanelCollapsedMaps(s, e) {
        rightAreaMenuRight.GetItemByName("ToggleRightPanelMaps").SetChecked(false);
    }
    ...
    window.onRightPanelCollapsedMaps = onRightPanelCollapsedMaps;
