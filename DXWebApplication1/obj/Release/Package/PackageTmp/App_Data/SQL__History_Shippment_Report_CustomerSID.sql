...
LEFT JOIN CUSTOMER_PROJECT C WITH (NOLOCK,NOWAIT) ON C.PROJECT_NO = A.OrderCustomerCode
WHERE 
		C.CUSTOMER_SID = @CUSTOMER_SID GROUP BY A.TripTripNo DROP TABLE #PURETRORDER